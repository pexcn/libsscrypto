 ...
 * blake3_hasher_init*(). Upstream calls the struct a private implementation
 * detail and is free to grow it, so let the host ask for the size rather than
 * hardcoding today's value on the managed side.
 */
